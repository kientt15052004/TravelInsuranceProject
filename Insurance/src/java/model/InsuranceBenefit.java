...
public class InsuranceBenefit {
    ...
    public InsuranceBenefit(int id, BigDecimal death_or_permanent_disability, BigDecimal death_due_to_illness, BigDecimal third_party_liability, BigDecimal lost_bank_card, BigDecimal kidnap_and_hostage, BigDecimal lost_or_damaged_golf_equipment, boolean is_deleted, BigDecimal medical_cost, BigDecimal emergency_transport, BigDecimal repatriation_vn, BigDecimal repatriation_abroad, BigDecimal hospital_visit, BigDecimal funeral_arrangement, BigDecimal child_care, BigDecimal hospital_allowance, BigDecimal accident_death_injury, BigDecimal trip_cancellation, BigDecimal companion_support, BigDecimal delayed_baggage, BigDecimal travel_documents, BigDecimal trip_delay) {
        this.id = id;
