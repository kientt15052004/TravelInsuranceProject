                    ...
                    function calculateInternationalFee() {
                        ...
                        if (days && people && result && rate1_7) {
                            try {
                                ...
                                const rate = parseFloat(rate1_7.value) || 0; // Lấy Rate cơ bản nhất để kiểm tra và gán tượng trưng
                                ...
                                // Tính phí và Cập nhật Preview (dùng Rate cơ bản nhất)
                                const fee_preview = rate * daysValue * peopleValue;
                                result.textContent = fee_preview.toLocaleString('vi-VN');

                                // **FIX LỖI QUAN TRỌNG:** Gán giá trị TƯỢNG TRƯNG vào trường ẩn 'price' (International)
                                // để server biết sản phẩm này CÓ GIÁ TRỊ, tránh bị server/DB hiểu là 0
                                if (priceField)
                                    priceField.value = '1';
